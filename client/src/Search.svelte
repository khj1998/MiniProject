...
x    }
    ...
    async function fetchResult(){
        const res = await fetch('http://swmteam64.herokuapp.com/v1/search',{
            method: "POST",
            headers:{
...
<Box>
    ...
    <p>
        <a href="https://docs.google.com/spreadsheets/d/1RXO7VcnJs-TO-b7f3uk-tuAnRgZHN3EnnN__TmyT_xI/edit"> 예약하러 가기 </a>
    </p>
